...
def build_tool_preview(tool_name: str, args: dict, max_len: int | None = None) -> str | None:
    ...
    *max_len* controls truncation.  ``None`` (default) defers to the global
    ...
    primary_args = {
        ...
        "browser_scroll": "direction", "browser_press": "key",
        "browser_console": "expression", "browser_vision": "question",
        "browser_snapshot": "full", "browser_get_images": None,
        "browser_back": None,
        "ha_call_service": "service", "ha_get_state": "entity_id",
        "ha_list_entities": "domain", "ha_list_services": "domain",
